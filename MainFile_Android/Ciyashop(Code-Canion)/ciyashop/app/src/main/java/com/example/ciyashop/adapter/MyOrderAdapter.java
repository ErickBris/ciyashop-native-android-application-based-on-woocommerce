...
//            tvProductName.setText(categoryList.name + "");
        ...
        if (list.get(position).status.toLowerCase().equals("any")) {
            holder.tvStatusDesc.setText(R.string.delivered_soon);
        } else if (list.get(position).status.toLowerCase().equals("pending")) {
            holder.tvStatusDesc.setText(R.string.order_is_in_pending_state);
        } else if (list.get(position).status.toLowerCase().equals("processing")) {
            holder.tvStatusDesc.setText(R.string.order_is_under_processing);
        } else if (list.get(position).status.toLowerCase().equals("on-hold")) {
            holder.tvStatusDesc.setText(R.string.order_is_on_hold);
        } else if (list.get(position).status.toLowerCase().equals("completed")) {
...
//            cell.lblDeliveredDate.text = [NSString stringWithFormat:@"Delivered On %@",timestamp1];
        } else if (list.get(position).status.toLowerCase().equals("cancelled")) {
            holder.tvStatusDesc.setText(R.string.order_is_cancelled);
        } else if (list.get(position).status.toLowerCase().equals("refunded")) {
            holder.tvStatusDesc.setText(R.string.you_are_refunded_for_this_order);
        } else if (list.get(position).status.toLowerCase().equals("failed")) {
            holder.tvStatusDesc.setText(R.string.order_is_failed);
        } else if (list.get(position).status.toLowerCase().equals("shipping")) {
            holder.tvStatusDesc.setText(R.string.delivered_soon);
        }
    }
