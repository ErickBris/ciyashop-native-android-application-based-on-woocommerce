...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_CART = "CREATE TABLE "
            ...
            + KEY_PRODUCT_ID + " TEXT," + KEY_QUANTITY + " INTEGER," + KEY_PRODUCT + " TEXT,"
...
//
    ...
    public List<String> getSearchHistoryList() {
        ...
        if (c.moveToFirst()) {
            do {
                search.add((c.getString(c.getColumnIndex(KEY_SEARCH_HISTORY_NAME))));
            } while (c.moveToNext());
        }
    ...
    public boolean getVariationProductFromCart(Cart cart) {
        ...
        String selectQuery = "SELECT  * FROM " + TABLE_CART + " WHERE "
                + KEY_PRODUCT_ID + " = '" + cart.getProductid() + "' and " + KEY_VARIATION_ID + " = '" + cart.getVariationid() + "'";
