...
public class NotificationActivity extends BaseActivity implements OnItemClickListner, OnResponseListner {
    ...
    public void onItemClick(int position, String value, int outerPos) {
        ...
        try {
            ...
            arr[0] = str;
            jsonObject.put("push_meta_id", new JSONArray(arr));
    ...
    public void getNotification() {
        PostApi postApi = new PostApi(this, "get_notification", this);
    ...
    public void deleteNotification(JSONObject jsonObject) {
        PostApi postApi = new PostApi(this, "delete_notifications", this);
    ...
    public void onResponse(final String response, String methodName) {
        ...
        if (methodName.equals("get_notification")) {
        ...
        } else if (methodName.equals("delete_notifications")) {
