...
function pgs_woo_api_taxonomy_add_new_meta_field($term) {
	...
	<div class="form-field term-thumbnail-wrap">
        ...
        <div class="clear"></div>
        <p class="description"><?php _e( 'Enter a value for this field','pgs-woo-api' ); ?></p>
    </div>
    <?php
...
function save_custom_tax_field( $termID ) {  
    ...
    if ( isset( $_POST['product_app_cat_thumbnail_id'] ) ) {		
		$termMeta['product_app_cat_thumbnail_id'] = isset( $_POST['product_app_cat_thumbnail_id'] ) ? $_POST['product_app_cat_thumbnail_id'] : '';		
        $termMeta = get_term_by( 'product_cat', 'id', 'product_cat', ARRAY_A );
        update_term_meta($termID, 'product_app_cat_thumbnail_id', $termMeta['product_app_cat_thumbnail_id']);
	} 
}
